...
6. [Actividad: clasifica el servicio](#)
8. [El nivel de dependencia como criterio de decisión](#) — Cierre
...
lanzó **Amazon Web Services (AWS)**, uno de los primeros y más influyentes servicios comerciales
...
que proporciona recursos` y es propiedad de un proveedor, el cual se ocupa de la mayoría de las
responsabilidades, y el usuario paga por los servicios que contrata.
...
- SaaS: Se proporciona una aplicación completamente administrada por el proveedor, el usuario únicamente consume el servicio.
...
- NIST SP 800-145  _The NIST Definition of Cloud Computing_.
